...
import type { AuthSession, BackendClient, CoveDBUser } from "./types";

export class Identity {
  private cached: CoveDBUser | null = null;
  private session: AuthSession | null = null;
  private sessionPromise: Promise<AuthSession> | null = null;
  private backend: BackendClient | undefined;

  constructor(private readonly options: Pick<CoveDBOptions, "backend" | "identityProvider">) {
