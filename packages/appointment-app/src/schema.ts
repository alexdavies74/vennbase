import { Vennbase, RowHandle, collection, defineSchema, field, type DbQueryProjectedRow, type InsertFields, type RowRef } from "@vennbase/core";
...
export type BookingKeyRow = DbQueryProjectedRow<Schema, "bookings">;
